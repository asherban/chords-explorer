...
export default function () {
    ...
    return (
        <div className="flex flex-row bg-black text-white items-center">
            <h1 className="text-lg font-bold p-4 flex-grow">Chords Explorer</h1>
            <WakeLockInfo active={wakeLockState}></WakeLockInfo>
            <MidiInfo inputs={inputs}></MidiInfo>
        </div>
    )
}